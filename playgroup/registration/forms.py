...
class ProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'avatar':forms.ClearableFileInput(attrs={'class':'form-control-fiel mt-3'}),
...
class EmailForm(forms.ModelForm):
    email = forms.EmailField(required=True,help_text="Requerido. 254 carácteres como máximo y debe ser valido.")
    ...
    def clean_email(self):
        email = self.cleaned_data.get("email")
        #comprueba si el email ha sido cambiado
